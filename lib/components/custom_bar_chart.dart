...
class CustomBarChart extends StatefulWidget {
  ...
  const CustomBarChart({super.key, required this.appColors});
...
class _CustomBarChartState extends State<CustomBarChart> {
  ...
  Widget build(BuildContext context) {
    return BarChartSample2(
      avgColor: widget.appColors.onSecondaryHeading,
      leftBarColor: widget.appColors.onPrimary,
      rightBarColor: widget.appColors.onSecondary,
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                Icon(Ionicons.flame, color: widget.leftBarColor, size: 32),
